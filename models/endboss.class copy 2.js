class Endboss extends MovableObject {
    ...
    animate() {
        ...
        setInterval(() => {
            if (this.isDeadEndboss()) {
              ...
              (this.isHurt()) {
               ...
               (world.character.x > 1560 && !this.hadFirstContact && !this.isHurt() && !this.isDeadEndboss()) {
                    this.playAnimation(this.IMAGES_ALERT);
                    console.log('Show Alert Images');
                } else if (!this.isHurt() && !this.isDeadEndboss()) {
                        setInterval(() => {
                            this.moveLeft();
        ...
        setInterval(() => {
            if (this.energy > 90 && this.energy < 100) {
                this.playAnimation(this.IMAGES_ALERT);
            } else if (this.energy < 90 && this.energy > 40) {
                this.playAnimation(this.IMAGES_ATTACK);
                this.endBossAttack();
        ...
        /* setInterval(() => {
            if (world.character.x > 1800 && this.hitEndboss() && !this.isDeadEndboss()) {
                this.hadFirstContact = true;
                this.playAnimation(this.IMAGES_HURT);
                console.log('Enboss is hurt');
            } else if (world.character.x > 2100 && !this.hadFirstContact && !this.hitEndboss() && !this.isDeadEndboss()) {
